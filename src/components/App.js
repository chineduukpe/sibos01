        ...
        <div class="main-menu">
            <div class="scroll">
                <ul class="list-unstyled">
                    <li class="active">
                        <a href="#dashboard">
                            <i class="iconsmind-Start-3"></i>
                            <span>Instant Videos</span>
                        </a>
                    </li>
                    <li>
                        <a href="#layouts">
                            <i class="iconsmind-Monitor-Tablet"></i> TV Channels
                        </a>
                    </li>
                    <li>
                        <a href="#applications">
                            <i class="iconsmind-Shopping-Cart"></i> Media Store
                        </a>
                    </li>
                    <li>
                        <a href="#ui">
                            <i class="iconsmind-Administrator"></i> My Files | Medias
                        </a>
                    </li>
                    <li>
                        <a href="#menu">
                            <i class="iconsmind-Gear-2"></i> Account Setting
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="list-unstyled" data-link="dashboard">
                    <li class="active">
                        <a href="Dashboard.Default.html">
                            <i class="simple-icon-briefcase"></i> Default
                        </a>
                    </li>
                    <li>
                            ...
                            <div class="owl-carousel dashboard-numbers">
                                <a href="#" class="card">
                                    <div class="card-body text-center">
                                        <i class="iconsmind-Start-3"></i>
                                        <p class="card-text mb-0">Instant Videos</p>
                                ...
                                <a href="#" class="card">
                                    <div class="card-body text-center">
                                        <i class="iconsmind-Monitor-Tablet"></i>
                                        <p class="card-text mb-0">TV Channels</p>
                                ...
                                <a href="#" class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text mb-0">Media Store</p>
                                ...
                                <a href="#" class="card">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text mb-0">My Files | Medias</p>
                                ...
                                <a href="#" class="card">
                                    <div class="card-body text-center">
                                        <i class="iconsmind-Gear-2"></i>
                                        <p class="card-text mb-0">Account Setting</p>
                            ...
                            <div class="scroll dashboard-list-with-thumbs">
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        ...
                                        <span class="badge badge-pill badge-theme-2 position-absolute badge-top-left">NEW</span>
                                    </a>
                                ...
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        ...
                                        <span class="badge badge-pill badge-theme-1 position-absolute badge-top-left">PROCESS</span>
                                    </a>
                                    <div class="pl-3 pt-2 pr-2 pb-2">
                                        <a href="#">
                                ...
                                <div class="d-flex flex-row mb-3">
                                    <a class="d-block position-relative" href="#">
                                        ...
                                        <span class="badge badge-pill badge-theme-3 position-absolute badge-top-left">DONE</span>
                                    </a>
                                    <div class="pl-3 pt-2 pr-2 pb-2">
                                        <a href="#">
